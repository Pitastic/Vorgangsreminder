...
#
# Je Vordruck ist eine eigene Datei zu verwenden !
# Je Eintrag ist eine eigene [Section] zu verwenden !
# 


[DEFAULT]
modul = (allgemein) jugendlicher BESCH


[Eintrag1]
l1	=	Eindrucksvermerk
l2	=	Formular "Erzieherisches Gespräch"
l3	=	Formular "Jugendamtsbericht der Polizei"
l4	=	Vorgang über BfJ schicken
